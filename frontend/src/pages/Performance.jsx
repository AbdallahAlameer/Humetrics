    ...
    return (
        <div className="flex flex-col gap-8 rise">
            <div className="flex justify-end -mb-4">
                <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-mono border ${performance.source === 'ml_model' ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20' : 'bg-orange-500/10 text-orange-400 border-orange-500/20'}`}>
                    {performance.source === 'ml_model' ? '🧠 ML Model Active' : '⚙️ Heuristic Fallback Active'}
                </span>
            </div>
